...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="JOB_ID" DataSourceID="SqlDataSource1">
            ...
            <InsertItemTemplate>
                ...
                <br />
                DEPT_ID:
                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="DEPT_NAME" DataValueField="DEPT_ID" SelectedValue='<%# Bind("DEPT_ID") %>'>
                </asp:DropDownList>
                ...
                <br />
                ROLE_ID:
                <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource4" DataTextField="ROLE_NAME" DataValueField="ROLE_ID" SelectedValue='<%# Bind("ROLE_ID") %>'>
                </asp:DropDownList>
